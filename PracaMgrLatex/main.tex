...
\newcommand{\Title}{Analiza narzędzi dostępnych w systemie linux służących do przeszukiwania zawartości tekstowych w zbiorze plików i archiwów}           % tytuł pracy po polsku
\newcommand{\TitleAlt}{Analysis of tools available on Linux system used for text search of files and archives}                     % thesis title in English
...
\newcommand{\Departament}{Inżynieria Przemysłowa}        % katedra promotora  (bez $\langle$ i $\rangle$)
