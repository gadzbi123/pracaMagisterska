...
foldery w których znajdowały się pliki bez rozszerzeń, które nie miałyby sensu,
do odczytania przez algorytm. Są to takie rozszerzenia jak .pdf, .zip, .tar czy
inne rozszerzenia archiwów jak i pliki zawierające obrazy takie jak .jpg czy 
gif. Wykonano testy na 3 algorytmach, gdzie odczytywano 5191 plików i łącznie 
około 240 MB danych. Oto rezultaty określonych algorytmów.
