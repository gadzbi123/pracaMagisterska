...
dostosowanie ich do problemu, który rozwiązujemy. Wykorzystanie wielu narzędzi
zaimplementowanych w jednym celu (tar, gzip, grep) i połączenie ich do 
skomplikowanej operacji przeszukiwania archiwów dałoby znacznie gorszy rezultat
...
skompresowanej treści, gdzie należy wykorzystać gzip.
